                    ...
                    <thead>
                        <tr>
                            <th style={{ width: '25%' }}>
                                ...
                                <button style={{ marginLeft: 10 }} onClick={this.checkAll} className="btn btn-info">Check All</button>
                                <button style={{ marginLeft: 10 }} onClick={this.unCheckAll} className="btn btn-info">Uncheck All</button>
                            </th>
                            <th>First Name</th>
                            <th>Last Name</th>
                            <th>Age</th>
